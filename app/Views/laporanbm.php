      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-md-6 order-md-1 order-last">
            <h3><?=$title?></h3>
            <h3>Berikut adalah halaman laporan barang masuk</h3>
            <p class="text-subtitle text-muted">Berikut ini adalah data laporan barang masuk <?=$title?></p>
          </div>
            ...
            <table class="table table-striped" id="table1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <!-- Detail Button -->
                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#detailModal" data-id="<?= $flora->id_bm ?>">!</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- User Details Form -->
        <form id="userDetailForm" action="<?= base_url('controller/update_bm') ?>" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="tglmsk" name="tglmsk" value="<?= $flora->tglmsk ?>" required disabled> 
          </div>
        </form>

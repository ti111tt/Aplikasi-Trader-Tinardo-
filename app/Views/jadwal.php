...
<body>
    ...
    $(document).ready(function() {
        var namaUser = "<?= $nama_user ?>"; // Ambil nama user dari PHP
            ...
            buttons: [
                {
                    ...
                    customize: function (win) {
                        $(win.document.body).prepend(
                            ...
                            '<h2>PT. Mitra Dagang Utama</h2>' +
                            '<p>Komplek Citra Buana Centre Park 1 Blok CC No. 5</p>' +
                            '<p>Email: mitradagangutama@gmail.com</p>' +
                            '<p>Telp: 08528978378</p>' +
                            '<p>Tanggal Print: ' + new Date().toLocaleDateString() + '</p>' +
                            '<p>Penanggung Jawab: ' + namaUser + '</p>' +
                            '</div>'
                        );
                        ...
                        $(win.document.body).find('td:nth-child(10), th:nth-child(10)').hide();
                    }
                }
            ]
        });

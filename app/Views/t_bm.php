        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
              <form action="<?= base_url('home/aksi_tbm') ?>" method="POST">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="tglmsk" class="col-sm-2 col-form-label">Tanggal Masuk</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" id="tglmsk" name="tglmsk" required>
                  </div>
                </div>

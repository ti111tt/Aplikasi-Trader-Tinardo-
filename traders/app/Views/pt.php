                ...
                <div class="card-body">
                    <form action="<?= base_url('home/method_update') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="caption" class="form-label">Catatan/Captions</label>
                                <textarea class="form-control" id="caption" name="caption" rows="4"><?= $flora->caption ?></textarea>
                                <!-- Tampilkan catatan yang sudah ada jika ada -->
                                <?php if (!empty($flora->caption)): ?>
                                    <p class="mt-2"><strong>Caption:</strong> <?= htmlspecialchars($flora->caption) ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
